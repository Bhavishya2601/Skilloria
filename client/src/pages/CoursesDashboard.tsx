      ...
      <div className="min-h-[calc(100vh-4rem)] flex flex-col gap-8 p-4 xs:p-6 bg-[#F9FAFB]">
        ...
        <div className="flex flex-col gap-3 font-manrope">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 my-4 xs:px-4">
            ...
            <div className="min-h-[250px] xs:h-[335px] flex flex-col justify-center items-center cursor-pointer border-2 border-dotted border-black hover:bg-[#F8F8F8] rounded-lg duration-500 transition-all" onClick={() => navigate('/courseform')}>
